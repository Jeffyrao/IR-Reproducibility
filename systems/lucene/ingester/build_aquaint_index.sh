...
sh target/appassembler/bin/TrecIngester -dataDir $AQUAINT_LOCATION -indexPath /scratch0/indexes/aquaint/cnt -threadCount 32 -docCountLimit -1

# Positional index
sh target/appassembler/bin/TrecIngester -dataDir $AQUAINT_LOCATION -indexPath /scratch0/indexes/aquaint/pos -positions -threadCount 32 -docCountLimit -1 
...
do
	...
	do
		...
		sh target/appassembler/bin/TrecDriver ${query_file} ${qrel_file} ${run_file} /scratch0/indexes/aquaint/${index}/index T > ${stat_file}
